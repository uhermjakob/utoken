...
* Languages tested so far: Amharic, Arabic, Assamese, Bengali, Bulgarian, Czech, Dutch, __English__, __Farsi__, French, Georgian, German, Greek (Ancient/Koine/Modern), Hebrew (Ancient/Modern), __Hindi__, Indonesian, Italian, Kannada, __Kazakh__, Korean, Lao, Lithuanian, Malayalam, Marathi, Norwegian, Odia, Pashto, Polish, Portuguese, Quechua, Russian, Somali, Spanish, Swahili, Swedish, __Tagalog__, Tamil, Telugu, Turkish, Urdu, __Uyghur__, Vietnamese, Welsh, Xhosa, Yoruba, Zulu
...
### Testing
_utoken_ has been tested on 60 corpora in 49 languages and 16 scripts (as of Oct. 14, 2021).
Tests include 
...
Plans include 
* Building resources, testing and fine-tuning of additional languages such as Armenian, Hausa, Hungarian.
