...
### Testing
_utoken_ has been tested on 53 corpora in 42 languages and 15 scripts (as of Oct. 11, 2021).
Tests include 
...
Plans include 
* Building resources, testing and fine-tuning of additional languages such as Hausa, Hungarian, Marathi, Odia, Quechua.
