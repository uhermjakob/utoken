...
"""This script re-tokenizes a few things, so that there is less clutter (fewer differences)
in comparison with utoken."""
...
if __name__ == "__main__":
    for line in sys.stdin:
       ...
       line = re.sub(r"\b(are|could|did|do|does|had|has|have|is|shall|should|was|were|will|would)n (['’])t\b", r"\1 n\2t", line, flags=re.IGNORECASE)
